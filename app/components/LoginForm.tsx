...
export default function  LoginForm() {
    ...
    const divStyle = "flex flex-col place-content-center justify-self-center text-navajo-white items-center bg-[#452B1F] m-5 w-4/5 h-130 rounded-2xl";
    ...
    return (
        <div className={"h-full"}>
            <h1 className={"text-4xl font-bold mb-12 text-[#452B1F] mt-10 text-center"}>Login Page</h1>
